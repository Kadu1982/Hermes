...
1. Aba **Este telemóvel** — pareamento feito e notificação Hermes ativa.
...
`Ei Jarvis`, `Oi Jarvis`, `Hey Jarvis`, `Ei Hermes`, `Jarvis`, `Hermes` — seguidas do comando.

## Limitações (MVP)

| Alexa comercial | Hermes (agora) |
|-----------------|----------------|
...
**Ajustes** → **Apps** → **Hermes** → **Bateria** → **Sem restrições** (recomendado com escuta ativa).

## Futuro

- Wake word offline (ex. Porcupine «Jarvis»)
- Integração «Ok Google, abrir Hermes»
